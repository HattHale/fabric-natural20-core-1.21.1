...
public class WarturtleScreen extends HandledScreen<WarturtleScreenHandler> {
    private static final Identifier GUI_TEXTURE_T0 =
            Identifier.of(Natural20Core.MOD_ID,"textures/entity/warturtle/gui/warturtle_gui_tier0.png");
    private static final Identifier GUI_TEXTURE_T1 =
            Identifier.of(Natural20Core.MOD_ID,"textures/entity/warturtle/gui/warturtle_gui_tier1.png");
    private static final Identifier GUI_TEXTURE_T2 =
            Identifier.of(Natural20Core.MOD_ID,"textures/entity/warturtle/gui/warturtle_gui_tier2.png");
    private static final Identifier GUI_TEXTURE_T3 =
            Identifier.of(Natural20Core.MOD_ID,"textures/entity/warturtle/gui/warturtle_gui_tier3.png");
